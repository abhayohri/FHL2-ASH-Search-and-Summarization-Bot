...
# ### response
# {
#     "answer":"Authentication issues refer to problems that Azure Multi-Factor Authentication (MFA) customers may experience when attempting to sign into Azure resources, such as Azure Active Directory, when MFA is required by policy. These issues can be caused by various factors, such as voice service providers, third-party cellular providers, or code issues related to the Microsoft Authenticator app. Microsoft responds to these issues by investigating and identifying the root cause, rolling out fixes or mitigations, and working with service providers to prevent future occurrences. Customers can make incidents less impactful by configuring Azure Service Health alerts. \n\n",
#     "next_skip":1,
#     "search_complete":false,
#     "source_tracking_ids":["RKWL-T98","FLX7-VD8","M0L-VC0","VS5M-RS8"]
# }
# 
# 
# ### second request:
# http://127.0.0.1:5000/askQuestion/?question=what%20are%20Authentication%20issues&skip=1
# 
# 
# ### response
# {
#     "answer":"Authentication issues refer to difficulties in receiving push notifications on Android phones to sign into Azure resources, such as Azure Active Directory, when Multi-Factor Authentication is required by policy. The cause of the issue was a third-party push notification service experiencing high rates of errors. Microsoft responded by manually performing a failover to the legacy channel following a safe deployment plan, which allowed Azure MFA to completely recover. They are working on improving the resiliency to automatically failover push notification traffic to the legacy channel if the primary channel experiences degradation. They are also improving their public documentation to recommend customers to complete the MFA request by opening up Microsoft Authenticator App and approving the request. \n\n",
#     "next_skip":2,
#     "search_complete":false,
#     "source_tracking_ids":["TrackingIDFKPH-7Z8"]
# }
# 
# ### third request:
...
# ### response
# {
#     "answer":"Authentication issues refer to difficulties experienced by customers when attempting to access Azure, Dynamics 365, and/or Microsoft 365 due to platform issues or third-party push notification service errors. The causes of these issues are identified and mitigated by Microsoft, and steps are taken to improve resiliency and prevent future incidents. \n",
#     "next_skip":3,
#     "search_complete":true,
